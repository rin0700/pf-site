...
const cards = [
  {
    ...
    title: 'HTML',
    description:
      '長く使用しているマークアップ言語であり、その能力を証明するWebクリエイター認定試験を取得しています。',
    category: 'Frontend',
  },
  {
    id: 'css',
    ...
    title: 'CSS',
    description:
      'HTMLと共にWebページのデザインを構築するためのスタイルシート言語として利用。ある程度使い慣れている。',
    category: 'Frontend',
  },
  {
    id: 'js',
    ...
    title: 'JavaScript',
    description:
      'Reactと同時に学習していき、最近使用する機会が増えているプログラミング言語。',
    category: 'Frontend',
  },
  {
    id: 'react',
    ...
    title: 'React',
    description:
      '現在積極的に学習しており、このポートフォリオサイトもReactを使用して作成しています。その他コンテストでの使用経験あり。',
    category: 'Frontend',
  },
  {
    id: 'aws',
    ...
    description:
      '最近のトレンドであるクラウドサービスの一つであることを知り、学習を開始。現在はAWS認定クラウドプラクティショナーを学習中。',
  ...
  },
  {
    ...
    title: 'Docker',
    description:
      'コンテストでの使用経験あり。コンテナ型仮想化技術を利用して開発環境を構築するために使用。',
    category: 'ToolsAndEnvironments',
  },
  {
    id: 'github',
    ...
    title: 'GitHub',
    description:
      '2024/5から積極的に使用し始め、基本的な操作は問題なく行えると思います。',
    category: 'ToolsAndEnvironments',
  },
  {
    id: 'java',
    ...
    title: 'Java',
    description:
      'プログラミング言語を学習した最初の言語であり、学習を開始したばかりの頃に使用していました。',
    category: 'Backend',
  },
  {
    id: 'swift',
    ...
    title: 'Swift',
    description:
      '独学で学習中のプログラミング言語。iOSアプリ開発に使用される言語であり、将来的にはiOSアプリ開発を行いたいと考えています。',
    category: 'Backend',
  },
  {
    id: 'vscode',
    ...
    description:
      'プログラミング勉強した頃から使用しているテキストエディタ。拡張機能を利用して効率的に開発を行っています。',
    category: 'ToolsAndEnvironments',
  },
  {
    id: 'mysql',
    ...
    title: 'MySQL',
    description:
      '授業やweb開発で使用した経験があり、少し苦手意識はあるが今後、開発で使用する予定',
    category: 'Backend',
  },
  {
    id: 'jquery',
    ...
    title: 'jQuery',
    description:
      '個人開発で使用した経験があり、簡単なアニメーションやイベント処理を行う際に使用していました。',
    category: 'Frontend',
  },
  {
    id: 'php',
    ...
    title: 'PHP',
    description:
      '授業で使用した経験があり、web開発やデータベースの処理に使用していました。',
    category: 'Backend',
  },
  {
    id: 'c#',
    ...
    title: 'C#',
    description:
      'ゲーム開発で使用した経験があり、Unityを使用してゲームを開発する際に使用していました。',
    category: 'Backend',
  },
  {
    id: 'swiftUI',
    ...
    title: 'SwiftUI',
    description:
      '個人開発でiOSアプリの制作にSwiftUIを採用していました。理解度は高いと思います。',
    category: 'Frontend',
  },
  {
    id: 'unity',
    ...
    title: 'Unity',
    description:
      'ゲーム開発での経験があり、C#を使用してゲームを開発する際に使用し、3Dゲームの開発に使用していました。',
    category: 'ToolsAndEnvironments',
  },
  {
    id: 'blender',
  ...
  },
  {
    ...
    title: 'Figma',
    description:
      'コンテスト制作の画面デザインに使用していました。UI/UXデザインに使用していました。',
    category: 'ToolsAndEnvironments',
  },
  {
    id: 'xcode',
    ...
    title: 'Xcode',
    description:
      'iOSアプリ開発に使用するIDEであり、Swiftを使用してiOSアプリを開発する際に使用していました。',
    category: 'ToolsAndEnvironments',
  },
  {
    id: 'canva',
    ...
    title: 'Canva',
    description:
      'さまざまな制作の画像編集に使用していました。設計書作成・アプリアイコンの作成に使用していました。',
    category: 'ToolsAndEnvironments',
  },
];
...
function LanguageCard() {
  ...
  const toolsAndEnvironments = cards.filter(
    (card) => card.category === 'ToolsAndEnvironments'
  );
